...
\begin{tikzpicture}[font=\sffamily, every node/.append style={outer sep=0pt}]
  ...
  \node[stepbadge, fill=blue] at ($(prior.north west)+(0.22,-0.17)$) {(a)};
  \node[stepbadge, fill=blue] at ($(predict.north west)+(0.22,-0.17)$) {(b)};
  \node[stepbadge, fill=orange] at ($(observe.north west)+(0.22,-0.17)$) {(c)};
  \node[stepbadge, fill=teal] at ($(update.north west)+(0.22,-0.17)$) {(d)};
  \node[stepbadge, fill=teal] at ($(score.north west)+(0.22,-0.17)$) {(e)};
