...
\ifBasisPolishedTables
  ...
  \newcolumntype{I}{>{\centering\arraybackslash}p{0.11\textwidth}}
...
\begin{table*}[t]
  ...
  \begin{tabularx}{\BasisHumanTableWidth}{@{}IQ@{}}
    \toprule
...
The human evaluation involved nine members of our laboratory and 10 contexts per domain; MediTOD included seven complete participants. The findings provide clear initial evidence for BASiS, but generalization to broader user populations requires external raters and more dialogue contexts. Future work should also refine how purpose-specific states, strategies, and desirable state sets are induced so that these strengths can be extended to a wider range of dialogue applications.
