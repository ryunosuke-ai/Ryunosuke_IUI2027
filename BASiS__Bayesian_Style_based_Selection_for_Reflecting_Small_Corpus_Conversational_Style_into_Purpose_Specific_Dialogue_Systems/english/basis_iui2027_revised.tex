...
For Step~1, we select 80 dialogues from each reference corpus. The selection covers the strategy, emotion, and problem annotations in ESConv; teacher moves in MathDial; and dialogue lengths and slots in MediTOD.
